...
rh = window.rh;
model = rh.model;
var defaultTopic = "565656_Topic.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("565656_Topic.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '03166557-970d-4e7b-9b22-12dcb37876ed' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "u1");
